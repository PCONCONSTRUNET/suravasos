      ...
      <Sheet open={openSheet} onOpenChange={setOpenSheet}>
        <SheetContent className="w-[400px] sm:w-[540px] sm:max-w-md overflow-y-auto">
          <SheetHeader>
            ...
            <SheetDescription>
              {selectedVenda?.tipo === 'DAV' ? 'Orçamento' : 'Venda'} Nº {selectedVenda?.id?.substring(0,8).toUpperCase()}
            </SheetDescription>
          </SheetHeader>
          ...
          <div className="mt-6 space-y-6">
            <div className="grid grid-cols-2 gap-4 text-sm bg-muted/30 p-4 rounded-lg">
              <div>
                ...
                <span className="font-medium">{selectedVenda?.clientes?.nome || "Cliente Removido"}</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="font-bold text-base">R$ {Number(selectedVenda?.valor_total || 0).toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
              </div>
            </div>
            ...
            <div className="flex gap-3 pt-6 border-t">
              <Button className="flex-1" variant="outline" onClick={() => handleShareWhatsApp(selectedVenda)}>
