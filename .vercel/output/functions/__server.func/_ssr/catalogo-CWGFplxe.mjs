...
import { _ as Search, it as ChevronsUpDown, lt as Check, p as ShoppingCart, u as Trash2 } from "../_libs/lucide-react.mjs";
...
import { a as SheetTitle, i as SheetHeader, n as SheetContent, o as SheetTrigger, t as Sheet } from "./sheet-DxhNg4O2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/catalogo-CWGFplxe.js
...
function PublicCatalogo() {
	...
	const addToCart = (produto) => {
		setCart((prev) => {
			if (prev.find((i) => i.produto.id === produto.id)) return prev.map((i) => i.produto.id === produto.id ? {
				...i,
				qtd: i.qtd + 1
			} : i);
			return [...prev, {
	...
	const setQuantity = (produtoId, newQ) => {
		setCart((prev) => prev.map((i) => {
			if (i.produto.id === produtoId) {
				if (newQ <= 0) return i;
				return {
	...
	(0, import_react.useEffect)(() => {
		const fetchProdutos = async () => {
			...
			const identifier = params.get("v") || p;
			if (identifier) {
				let query = supabase.from("vendedores").select("id, nome, telefone").eq("status", "Ativo");
				if (identifier.length === 8 && /^[0-9a-fA-F-]+$/.test(identifier)) query = query.ilike("id", `${identifier}%`);
				else query = query.ilike("nome", `${identifier}%`);
				const { data: parceiros } = await query.limit(1);
				if (parceiros && parceiros.length > 0) setPartner(parceiros[0]);
			}
			setLoading(false);
		};
		fetchProdutos();
	...
	const finalizeOrder = () => {
		...
		let telefoneDestino = "5519997331112";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					partner && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mb-6 bg-brand/10 border border-brand/20 text-brand p-3 rounded-xl flex items-center justify-center text-sm font-medium animate-in fade-in slide-in-from-top-4",
						children: ["Você está comprando com o parceiro: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
							className: "ml-1",
							children: partner.nome
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Confira nossos vasos, suportes e acessórios e faça seu pedido diretamente pelo WhatsApp."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}) : p.emoji || "🪴", p.estoque < 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
										className: "font-display text-lg font-bold text-slate-800 leading-tight",
										children: p.nome
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "text-primary font-display text-2xl font-extrabold mt-2",
										children: ["R$ ", Number(p.valor).toFixed(2).replace(".", ",")]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "py-3 text-xs text-slate-500 space-y-1.5 border-b mb-4",
										children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-auto",
										children: cart.find((c) => c.produto.id === p.id) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between bg-slate-100 rounded-lg p-1.5 h-11 border border-slate-200",
											children: [
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "mr-2 h-5 w-5" }), "Adicionar"]
										})
									})
								]
							})]
			...
			cart.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-200 shadow-[0_-10px_40px_rgba(0,0,0,0.08)] z-40 flex items-center justify-between lg:px-12 animate-in slide-in-from-bottom-8",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-sm text-muted-foreground font-medium",
					children: [cart.reduce((a, c) => a + c.qtd, 0), " itens no carrinho"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-xl font-bold text-slate-800",
					children: ["R$ ", cart.reduce((a, c) => a + c.qtd * Number(c.produto.valor), 0).toFixed(2).replace(".", ",")]
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
					asChild: true,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						className: "bg-success text-success-foreground hover:bg-success/90 h-12 px-6 shadow-md font-bold text-base rounded-full",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "mr-2 h-5 w-5" }), " Ver Carrinho"]
					})
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetHeader, {
							className: "p-6 border-b bg-slate-50/50",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetTitle, {
								className: "flex items-center gap-2 text-2xl font-display font-bold",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "h-6 w-6 text-brand" }), " Seu Carrinho"]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex-1 overflow-y-auto p-4 space-y-4",
							children: cart.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex gap-4 p-4 bg-white rounded-xl border border-slate-100 shadow-sm relative group",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										onClick: () => removeFromCart(item.produto.id),
										className: "absolute -top-2 -right-2 bg-destructive/10 text-destructive p-1.5 rounded-full hover:bg-destructive hover:text-destructive-foreground transition-colors",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-4 w-4" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "w-16 h-16 bg-slate-50 rounded-lg flex items-center justify-center text-3xl shrink-0",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "text-brand font-bold text-sm mb-3",
												children: ["R$ ", Number(item.produto.valor).toFixed(2).replace(".", ",")]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex items-center bg-slate-100 rounded-lg p-1 w-max border border-slate-200",
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
														onClick: () => updateQuantity(item.produto.id, -1),
														className: "h-7 w-7 bg-white rounded shadow-sm flex items-center justify-center font-medium hover:bg-slate-50",
														children: "−"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
														type: "number",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-6 border-t bg-white shadow-[0_-10px_20px_rgba(0,0,0,0.03)] z-10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhatsAppIcon, { className: "mr-2 h-6 w-6" }), "Enviar Pedido"]
							})]
						})
					]
				})] })]
