...
//#region node_modules/.nitro/vite/services/ssr/assets/app.vendas-parceiros-BLaMZctQ.js
...
function VendasParceiros() {
	...
	const fetchVendas = async () => {
        ...
        `).not("vendedor_id", "is", null).or("status_aprovacao.neq.Pendente,status_aprovacao.is.null").order("created_at", { ascending: false });
	...
	const openSaleDetails = async (sale) => {
		...
		setSaleItems([]);
		try {
			const { data, error } = await supabase.from("vendas_itens").select("*, produto:produtos(nome, emoji)").eq("venda_id", sale.id);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			}) }) : vendasFiltradas.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
