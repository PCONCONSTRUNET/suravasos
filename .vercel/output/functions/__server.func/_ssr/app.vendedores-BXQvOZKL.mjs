...
//#region node_modules/.nitro/vite/services/ssr/assets/app.vendedores-BXQvOZKL.js
...
function VendedoresAdmin() {
	...
	const fetchData = async () => {
		...
		try {
			...
			const { data: vendasData, error } = await supabase.from("vendas").select("*, vendedor:vendedores(nome), cliente:clientes(nome, cpf_cnpj, telefone)").not("vendedor_id", "is", null).order("created_at", { ascending: false });
