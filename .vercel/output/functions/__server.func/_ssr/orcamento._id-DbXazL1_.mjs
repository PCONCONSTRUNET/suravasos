...
import { t as Route } from "./orcamento._id-yCXanuBp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/orcamento._id-DbXazL1_.js
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(VivaverdeLogo, { size: "small" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: config?.razao_social || "VIVAVERDE VASOS E SUPORTES"
						}),
						config?.cnpj && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["CNPJ: ", config.cnpj] }),
						config?.endereco && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: config.endereco }),
						config?.telefone && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Tel: ", config.telefone] }),
						config?.email_contato && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: config.email_contato }),
						!config && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: tituloDocumento
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm font-medium mt-1",
							children: [
								venda.tipo === "DAV" ? "DAV" : "Pedido",
								" Nº: ",
						...
						venda.vendedor?.nome && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-sm mt-1",
							children: ["Vendedor: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-medium",
								children: venda.vendedor.nome
							})]
						}),
						venda.tipo === "DAV" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
