...
//#region node_modules/.nitro/vite/services/ssr/assets/parceiro.pdv-BFRXRU2Y.js
...
function ParceiroPDV() {
	...
	const [vendedorInfo, setVendedorInfo] = (0, import_react.useState)(null);
	const [searchTerm, setSearchTerm] = (0, import_react.useState)("");
	const [davGeradoId, setDavGeradoId] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		const init = async () => {
			const { data: { session } } = await supabaseParceiro.auth.getSession();
			if (session) {
				const { data: vData } = await supabaseParceiro.from("vendedores").select("id, status, nome").eq("user_id", session.user.id).single();
				if (vData) {
					setVendedorInfo({
						id: vData.id,
						nome: vData.nome
	...
	const submitOrder = async (e) => {
		...
		try {
			...
			if (!finalClienteId) {
				...
				if (clientForm.endereco && clientForm.endereco.trim() !== "") payload.endereco = clientForm.endereco.trim();
			...
			const { data: dav, error: davError } = await supabaseParceiro.from("vendas").insert([{
				tipo: "DAV",
				status: "Pendente",
				status_aprovacao: "Pendente",
				valor_total: subtotal,
			...
			if (!davError && dav) {
				...
				await supabaseParceiro.from("vendas_itens").insert(davItensToInsert);
			} else if (davError) {
	...
	if (!vendedorInfo) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "w-[90vw] sm:max-w-[425px] rounded-2xl text-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						className: "flex-col gap-2 sm:justify-center",
						children: [davGeradoId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							className: "w-full bg-[#25D366] hover:bg-[#128C7E] text-white h-12 text-lg",
							onClick: handleShareWhatsApp,
							children: "Enviar Orçamento por WhatsApp"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
					className: "w-[95vw] max-w-[500px] max-h-[90vh] overflow-y-auto rounded-2xl p-5 sm:p-6",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						onSubmit: submitOrder,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Finalizar Geração de Orçamento / Pedido" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Preencha os dados abaixo. Eles sairão no PDF oficial e serão enviados à loja." })] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "font-semibold text-brand text-sm border-b pb-1",
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Dinheiro / Pix" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Cartão de Crédito" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Cartão de Débito" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Boleto a Prazo" })
												]
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Retirada" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "FOB (Por conta do cliente)" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "CIF (Por conta da loja)" })
												]
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									children: loading ? "Gerando..." : "Gerar Pedido e Orçamento"
								})]
							})
						]
					})
