...
import { bt as ArrowLeft, it as ChevronsUpDown, lt as Check, p as ShoppingCart, u as Trash2, v as Save, x as Plus } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app.venda-nova-C6rG_6S5.js
...
function NovaVenda() {
	...
	const [openModalCliente, setOpenModalCliente] = (0, import_react.useState)(false);
	const [novoCliente, setNovoCliente] = (0, import_react.useState)({
		nome: "",
		cpf_cnpj: "",
		telefone: "",
		endereco: ""
	});
	const [loadingCliente, setLoadingCliente] = (0, import_react.useState)(false);
	...
	const executarSalvamentoVenda = async (idDoCliente) => {
		setLoading(true);
		try {
			const subtotal = itens.reduce((acc, i) => acc + i.subtotal, 0);
			const totalVenda = subtotal - subtotal * (descontoPerc / 100) + freteValor;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
			...
			onOpenChange: setOpenModalCliente,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
				className: "sm:max-w-[425px]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Preencher Dados do Cliente" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogDescription, { children: [
						"Você não selecionou um cliente. Preencha os dados abaixo para cadastrar e emitir o ",
						tipo === "DAV" ? "Orçamento" : "Pedido",
						" automaticamente."
					] })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Nome / Empresa *" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Endereço / Cidade" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogFooter, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						disabled: loadingCliente,
						className: "bg-gradient-brand text-primary-foreground",
						children: loadingCliente ? "Emitindo..." : "Confirmar e Emitir"
					})] })
				]
			})
		})
