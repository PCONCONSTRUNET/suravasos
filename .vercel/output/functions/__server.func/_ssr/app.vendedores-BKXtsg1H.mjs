...
import { C as Phone, J as DollarSign, M as Mail, W as Eye, at as CircleCheck, c as TrendingUp, m as Settings, n as Wallet, nt as CircleX, u as Trash2 } from "../_libs/lucide-react.mjs";
...
import { a as SheetTitle, i as SheetHeader, n as SheetContent, r as SheetDescription, t as Sheet } from "./sheet-D34QUmVZ.mjs";
...
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-ny1MBpqA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app.vendedores-BKXtsg1H.js
...
function VendedoresAdmin() {
	...
	const fetchData = async () => {
		...
		try {
			...
			const { data: vendasData, error } = await supabase.from("vendas").select("*, vendedor:vendedores(nome), clientes(nome, cpf_cnpj, telefone)").not("vendedor_id", "is", null).order("created_at", { ascending: false });
	...
	const aprovarVenda = async (venda) => {
		...
		try {
			...
			let valorComissao = 0;
			if (vendedorCompleto) if (vendedorCompleto.tipo_comissao === "porcentagem") valorComissao = valorVenda * (Number(vendedorCompleto.valor_comissao || 0) / 100);
			else valorComissao = Number(vendedorCompleto.valor_comissao || 0);
			...
			if (valorComissao > 0) await supabase.from("contas_pagar").insert([{
	...
	const excluirVenda = async (id, statusAprovacao) => {
		setConfirmModal({
			isOpen: true,
			title: "Excluir Venda",
			...
			onConfirm: async () => {
				try {
					...
					await supabase.from("contas_pagar").update({
						status: "Pago",
						data_pagamento: (/* @__PURE__ */ new Date()).toISOString().split("T")[0]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									size: "sm",
									variant: "ghost",
									onClick: () => excluirVenda(v.id, v.status_aprovacao),
